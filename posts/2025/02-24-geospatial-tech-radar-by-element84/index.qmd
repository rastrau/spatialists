...
author:
  - name: Guest author Stephan Heuel
...
PS: There is a Swiss variation of **a geospatial** tech radar called [GIS Trends](https://gistrends.ch) by SOGI **(available only in German)**. However, it has a different focus and level of depth.