...
![Digital cartography operator using the [Scitex system](https://www.exscite.org/2013/06/22/scitex-response-250-cartography-market/) (white-balance adjusted; source: [swisstopo historic](https://www.swisstopohistoric.ch))](operator-using-scitex.jpg "Digital cartography operator using the Scitex system (white-balance adjusted; source: swisstopo historic)")
