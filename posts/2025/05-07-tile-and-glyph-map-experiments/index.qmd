...
From David O'Sullivan[^O'Sullivan], self-described geospatial "problem solver, researcher, 
...
to show the afore-mentioned data in a single map: tile maps using tilings of 
...
I *love* the out-of-the-box experimentation of this article and the more 
