...
Overall an [interesting (albeit, clearly *inside*[^interview]) view on OMF, OSM, and the evolution 
of geodata in general](https://gridisnotajournal.de/articles/anderson-2025-overture/).
...
[^interview]: Slightly odd minor point: The article is formatted like an 
interview (and there are credits for "interview and editing" at the end of it), 
but the interviewee is credited as author in the byline.