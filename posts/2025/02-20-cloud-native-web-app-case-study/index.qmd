...
description: "From Stephan Heuel comes a very interesting case study that 
explores the possibilies of web apps based on the 'cloud-native geo' paradigm, 
the Swiss Rooftop Explorer."
---
...
e.g. [under the swissEO^[Swiss Earth Observation] product line](https://data.geo.admin.ch/browser/index.html#/collections/ch.swisstopo.swisseo_s2-sr_v100?.language=en) (cf. also 
