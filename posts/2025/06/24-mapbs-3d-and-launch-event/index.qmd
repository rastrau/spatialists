...
description: "The canton of Basel-Stadt presents its new #3D #geoportal, MapBS 3D, offering interactive 3D maps with detailed building models, construction projects, and several analytical tools. The new portal is introduced in a “lunch & learn” style webinar this Thursday."
---

In its [latest newsletter edition](https://mailchi.mp/bs.ch/lunchlearn_3d), the canton of Basel-Stadt announces the successful conclusion of the "3D Geoportal" project. The most notable outcome of the project is [MapBS 3D](https://3d.geo.bs.ch/)[^BS]. 
...
[^BS]: To the English-speaking reader: "BS" being, you know, the official state abbrevation of "Basel-Stadt" (i.e., "Basel-City").