...
description: "Discovering #OGC and other geoservices endpoints in web maps is now effortless with the Chromium-based Geo Hound extension. It automatically identifies and collects geoservices—along with geospatial files like KML, GeoJSON, Shapefiles, and GeoTIFF—into a handy list for your convenience."
---
