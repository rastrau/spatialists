...
![Example use-cases for Panoramax data. Some of the Panoramax material (like this) still betrays its French origins, but virtually all Panoramax website content is in English now. (source: Panoramax)](panoramax-use-cases.png "Example use-cases for Panoramax data (source: Panoramax)")
