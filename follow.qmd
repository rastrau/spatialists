---
title: "Follow the RSS feed or in the Fediverse"
image: false
about:
  template: solana
---
...
Of follow Spatialists on Mastodon:

<https://mapstodon.space/@spatialists>

<br><br>

## What is an RSS feed?^[These explanations are based on [aboutfeeds.com](https://aboutfeeds.com), CC-BY-NC-SA [Matt Webb](https://interconnected.org/). The article ["Why I still love and use RSS feeds in 2025"](https://news.itsfoss.com/why-use-rss-feeds/) goes into a bit more detail regarding the advantages of consuming news through RSS instead of an algorithmic feed.]
